...
def run():
    ...
    wynik = integracje_worker.raport_mailerlite(ZADANIE_ML, klient=AtrapaMailerLite())
    ...
    pusty = integracje_worker.raport_mailerlite(ZADANIE_ML, klient=AtrapaMailerLitePusta())
    ...
    z_mocka = integracje_worker.raport_mailerlite(ZADANIE_ML, klient=AtrapaMailerLiteMock())
    ...
    odmowa = integracje_worker.raport_mailerlite(ZADANIE_ML, klient=AtrapaMailerLiteOdmowa())
    ...
    zan_odmowa = integracje_worker.podsumowanie_zanfia(ZADANIE_ZAN, klient=AtrapaZanfiaOdmowa())
    ...
    try:
        ...
        zan_ok = integracje_worker.podsumowanie_zanfia(ZADANIE_ZAN, klient=klient_zan)
