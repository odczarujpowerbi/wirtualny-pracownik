...
| `task_feedback_requester.py` | Prosi o feedback po zamknięciu zadania: komentarz + zadanie w Projectly + mail. Opis zadania feedbackowego niesie dane z Projectly (estymacja, czas realny, wyliczone odchylenie) oraz cel i kryteria odbioru | ✅ end-to-end na mocku, w tym idempotencja (nie pyta drugi raz o to samo zadanie, `runs/feedback_requested.json`) + `task_feedback_requester_smoke_test.py` (odsiewanie zadań feedbackowych, brief z danymi, cel/kryteria) |
