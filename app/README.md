...
| `mailerlite_client.py` | Konektor MailerLite REST API (kampanie + statystyki), **fail closed** — brak klucza to wyjątek, nie ciche dane z mocka | ⚠️ nazwy pól niezweryfikowane na żywo (brak klucza na maszynie); paginacja i filtr dat po naszej stronie. Przy pierwszym uruchomieniu z kluczem: `opisz_kontrakt()` |
