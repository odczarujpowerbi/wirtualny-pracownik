...
REM start-agent-dev.bat (rola "dev"), na TEJ SAMEJ maszynie i repo. Odpala TE SAME
...
REM
REM Uruchamiaj OBOK start-agent-dev.bat (dwa osobne okna/procesy), nie zamiast niego.
REM ============================================================================
chcp 65001 > nul
cd /d "%~dp0app"
