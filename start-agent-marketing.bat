...
REM start-agent.bat (rola "dev") i start-agent-checker.bat (rola "checker"),
...
REM
REM Uruchamiaj OBOK start-agent.bat i start-agent-checker.bat (trzy osobne
REM okna/procesy), nie zamiast nich.
REM ============================================================================
chcp 65001 > nul
cd /d "%~dp0app"
